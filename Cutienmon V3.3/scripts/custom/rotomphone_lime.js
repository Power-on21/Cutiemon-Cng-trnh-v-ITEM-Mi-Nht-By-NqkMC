...
.title('serp.main.rotom_phone_lime.list')
...
const form = new ActionFormData()
.title("serp.main.rotom_phone_lime.grid")
...
const form = new ActionFormData().title("serp.main.rotom_phone_lime.list");
for (let i = 0; i < 10; i++) {
form.button({
'rawtext': [
...
if (ev.itemStack.typeId === 'serp:rotomphone_lime') {
