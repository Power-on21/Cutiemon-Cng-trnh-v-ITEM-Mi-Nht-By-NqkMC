...
.title('serp.main.rotom_phone.list')
...
const form = new ActionFormData()
.title("serp.main.rotom_phone.grid")
...
const form = new ActionFormData().title("serp.main.rotom_phone.list");
for (let i = 0; i < 10; i++) {
form.button({
'rawtext': [
...
if (ev.itemStack.typeId === 'serp:rotomphone') {
