...
.title('serp.main.rotom_phone_black.list')
...
const form = new ActionFormData()
.title("serp.main.rotom_phone_black.grid")
...
const form = new ActionFormData().title("serp.main.rotom_phone_black.list");
for (let i = 0; i < 10; i++) {
form.button({
'rawtext': [
...
if (ev.itemStack.typeId === 'serp:rotomphone_black') {
