...
.title('serp.main.rotom_phone_red.list')
...
const form = new ActionFormData()
.title("serp.main.rotom_phone_red.grid")
...
const form = new ActionFormData().title("serp.main.rotom_phone_red.list");
for (let i = 0; i < 10; i++) {
form.button({
'rawtext': [
...
if (ev.itemStack.typeId === 'serp:rotomphone_red') {
