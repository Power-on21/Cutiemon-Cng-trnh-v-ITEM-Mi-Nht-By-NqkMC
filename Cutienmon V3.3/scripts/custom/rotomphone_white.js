...
.title('serp.main.rotom_phone_white.list')
...
const form = new ActionFormData()
.title("serp.main.rotom_phone_white.grid")
...
const form = new ActionFormData().title("serp.main.rotom_phone_white.list");
for (let i = 0; i < 10; i++) {
form.button({
'rawtext': [
...
if (ev.itemStack.typeId === 'serp:rotomphone_white') {
